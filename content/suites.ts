...
export const suites: Record<Suite["slug"], Suite> = {
  forest: {
    slug: "forest",
    name: "סוויטת יער",
    h1: "סוויטת יער: חוויה זוגית עוטפת, כפרית וחמימה",
    // Leads with primaryKeyword, per the title rule in lib/seo.ts.
    metaTitle: "צימר עם ג'קוזי בגולן | סוויטת יער במיקאסה, מושב שעל",
    metaDescription:
  ...
  rain: {
    slug: "rain",
    name: "סוויטת גשם",
    h1: "סוויטת גשם: חוויה זוגית מרווחת, בהירה ונושמת",
    metaTitle: "צימר רומנטי לזוג בגולן | סוויטת גשם במיקאסה, מושב שעל",
    metaDescription:
